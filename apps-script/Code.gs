...
const DOWNLOAD_URL = "https://github.com/ioprakash/breejindustry-tracker/raw/main/brij-industry-tracker-v1.5.6.apk";
  ...
  try {
    ...
    if (action === 'getLatestVersion') {
      return ContentService.createTextOutput(JSON.stringify({
        ...
        notes: "Fixed browser download update link. Previous: Updated app icon."
